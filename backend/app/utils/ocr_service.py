                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": (
                                "请仅提取图片中的题目/文字内容，按原换行输出纯文本，"
                                "不要解释、不要翻译、不要补充答案。"
                                "数学表达式用规范写法：分数写成 \\frac{分子}{分母}"
                                "（如 17/2 写成 \\frac{17}{2}），带分数必须保留前面的整数部分（如 1又1/2 写成 1\\frac{1}{2}，切勿遗漏整数 1），"
                                "上标写成 ^（如 x² 写成 x^2，(-\\frac{3}{2})² 写成 (-\\frac{3}{2})^2），"
                                "根号写成 \\sqrt{}，乘号除号写成 \\times、\\div。"
                            ),
                        },
