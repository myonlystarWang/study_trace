...
rem 协议由 config\cloudflared\config.yml 的 protocol 决定，当前 http2
start "" /b cloudflared.exe --config "config\cloudflared\config.yml" --logfile "data\cloudflared.log" tunnel run study-trace
